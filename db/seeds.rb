...
homer =
  Donut.create(
    name: "Homer's Donut",
    description: 'Raised ring with strawberry frosting & round sprinkles.',
    image_url:
...
blueberry =
  Donut.create(
    name: 'Traditional Blueberry',
    description:
      'These baked blueberry donuts packed with fresh blueberries & topped with a sugary glaze to make the perfect breakfast with a cup of coffee.',
...
zebra =
  Donut.create(
    name: 'Iced Zebra',
    description:
      'Enjoy this delicious yeast raised ring donut, topped with white icing & drizzled with select chocolate icing.',
...
mm =
  Donut.create(
    name: 'M & M Topped',
    description:
      'M&M Cake Doughnuts are fried perfection, topped with a thick white chocolate glaze & crunchy m&m candies & are way quicker to make than yeast doughnuts!',
...
classic =
  Donut.create(
    ...
    description:
      'The doughnuts are super light & fluffy - this is an oil based dough rather than a butter based, so the doughnuts are a bit lighter in flavour, making them the perfect vessel for a delicious spicy cinnamon sugar coating. I love them, & I know that you will too.',
...
chocolatesprinks =
  Donut.create(
    ...
    description:
      'Yeast-free & baked instead of fried, these chocolate sprinkle donuts are a fun one bowl treat. Soft & fluffy vanilla cake donuts topped withchocolate glaze & lots of sprinkles.',
...
apple =
  Donut.create(
    name: 'Apple Fritter',
    description:
      'Fried dough with apple chunks & cinnamon & topped with glaze.',
...
chocovanilla =
  Donut.create(
    name: 'Chocolate Iced',
    description:
      'A favorite of many, this yummy variety is filled with our light & smooth cream filling. It is then dipped in our classic chocolate icing to create a delectably balanced treat.',
    image_url:
...
cake =
  Donut.create(
    name: 'Cake Batter',
    description:
      'We love celebrating birthdays every day with a scrumptious cake batter donut. Filled with cake batter cream, topped with yellow icing & bright confetti sprinkles, this doughnut is perfect for any party.',
    image_url:
...
cruller =
  Donut.create(
    name: 'Glazed Cruller',
    description:
      "Rich & moist, our cruller is an enticing twist on our classic cake doughnut... &, of course, it's finished off with our uniquely delicious signature glaze.",
    image_url:
...
oreo =
  Donut.create(
    ...
    description:
      'The Original Glazed Dnut covered in rich OREO® Cookie Glaze, filled with Cookies & cream, & finished with an icing drizzle & oreo cookie pieces.',
    image_url:
...
Review.create(
  review: 'The donut is hard & dry! Probably been on the shelves for too long.',
  rating: 2,
  customer_id: anne.id,
  donut_id: cruller.id,
)
